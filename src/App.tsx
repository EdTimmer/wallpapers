        ...
        <div className="instructions">
          ...
          <Canvas orthographic camera={{ position: [0, 0, 10], zoom: 50 }}>
            <Routes>
              ...
              <Route path="/aurora" element={<Aurora speed={0.47} intensity={0.8} blend={1.0} saturation={1.0} scale={1.4} verticalOffset={0.05} firstColor='#ddff00' secondColor='#00b30c' thirdColor='#00bfff' opacity={1.0} grainAmount={0.0} vignette={0.0} vignetteOpacity={1.0} fadeSpeed={0.1} distortionRadius={0.01} distortionStrength={0.0} />} />
              ...
              <Route path="/dot-grid" element={<DotGrid dotSize={4} gap={19} baseColor='#1a1a1a' activeColor='#ffffff' proximity={70} activeDuration={1.6} mouseInteraction={true} activeOpacity={1.0} baseOpacity={1.0}  />} />
